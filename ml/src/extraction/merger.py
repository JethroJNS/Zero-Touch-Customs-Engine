...
class ShipmentEntities:
    # Entity hasil ekstraksi lengkap untuk shipment.
    # HEADER / IDENTIFIER
    ...
    def compute_confidence(self) -> float:
        # Hitung overall extraction confidence.
        confidences = []
...
class Merger:
    # Merge header dan item jadi ShipmentEntities.
    def __init__(self):
    ...
    def merge(
        ...
        # Merge semua hasil dokumen jadi satu ShipmentEntities.
        entities = ShipmentEntities()

        # Step 1: Validasi header entities
        ...
        # Step 2: Isi field dengan priority CI > BL > PL
        ...
        # Parties: CI untuk seller/buyer, BL untuk shipper/consignee
        ...
        # Fallback: jika parties tidak terlabel
        ...
        # Step 3: Validasi dan assign items
    ...
    def _fill_header_field(
        ...
        # Isi header field dari validation results.
        result = validated.get(field_name)
        if result is None or not result.value:
            return

        # Semua validation results diinclude
    ...
    def _compute_totals(self, entities: ShipmentEntities) -> None:
        # Compute totals dari line items.
